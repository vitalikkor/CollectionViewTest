...
class ViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource  {
    ...
    override func viewDidLoad() {
        ...
        collectionView.register(UINib.init(nibName: "CalendarMonthSupplementaryView", bundle: nil), forSupplementaryViewOfKind:  CalendarMonthViewCustomLayout.Element.supplementaryView.kind, withReuseIdentifier: "SupplementaryCell")
    ...
    func numberOfSections(in collectionView: UICollectionView) -> Int {
        return dataSource.threeMonthsdateRange.count
    }
    
    
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return dataSource.eventsInSection(section).count
    }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let eventType = dataSource.eventsInSection(indexPath.section)[indexPath.row]
        let title: String
        switch eventType {
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        ...
        supplementaryView.dayTitleLabel.text = dataSource.date(forSection: indexPath.section)
